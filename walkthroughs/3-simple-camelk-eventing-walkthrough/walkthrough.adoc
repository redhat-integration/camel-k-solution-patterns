...
In the link:{openshift-add-url}[OpenShift Console->Developer->+Add, window="_blank"], create a new OpenShift project:
...
If you have logged in as a cluster administrator:
...
If you have logged in as a developer:

* Go to link:{openshift-add-url}[OpenShift Console->Developer->+Add, window="_blank"] in the console. Do you see your newly created project displayed in the *Project* drop-down list?
